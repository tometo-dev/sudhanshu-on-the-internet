...
import { WrongHaloEffect } from "./wrong-halo-effect";
import { WrongHaloEffect2 } from "./wrong-halo-effect-2";
...
<BlogTimestamp timestamp="July 26, 2024" />
...
```jsx
  <img src={logo} alt="logo" className="m-auto size-10 animate-pulse [box-shadow:0px_0px_250px_100px_blue]" />   
```
...
This finally gave me the desired effect. The image was pulsing and the box shadow was only around the image.
<HaloEffect />