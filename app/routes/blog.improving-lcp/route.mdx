...
So, I after trying to triage the problem (and failing), I did the next best thing: I asked for help.
...
So, either we needed to change the way the image was being used,
...
It also supports image [source-sets](https://developer.mozilla.org/en-US/docs/Learn/HTML/Multimedia_and_embedding/Responsive_images):
...
I didn't know about this before, but now I do. And now you do too! 🎉
