...
>
> - [David K Piano](https://twitter.com/DavidKPiano) (paraphrased)
...
> <span>
>   (Here, I'm using a very specific problem that I had faced, but it
>   demonstrates a usage that is applicable to a wide range of scenarios)
> </span>
