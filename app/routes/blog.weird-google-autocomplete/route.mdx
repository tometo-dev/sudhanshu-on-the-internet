...
would start showing up again. So, I that's what I did: a hacky solution to unmount/remount the component whenever the user selection changed. This meant that whenever
